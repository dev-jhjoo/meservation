# Generated by Django 4.2.2 on 2023-07-25 06:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True, verbose_name='create_at')),
                ('followed_user', models.ForeignKey(db_column='followed_user_uuid', on_delete=django.db.models.deletion.CASCADE, related_name='followed_user_uuid', to=settings.AUTH_USER_MODEL, to_field='uuid')),
                ('following_user', models.ForeignKey(db_column='following_user_uuid', on_delete=django.db.models.deletion.CASCADE, related_name='following_user_uuid', to=settings.AUTH_USER_MODEL, to_field='uuid')),
            ],
            options={
                'db_table': 'friendship',
            },
